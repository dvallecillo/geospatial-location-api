...
- For this MVP I've loaded the `locations.csv` on application startup, but didn't implement keys flush after stopping the application (It will store duplicates If application loads multiple times).
